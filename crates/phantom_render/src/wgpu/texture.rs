use phantom_dependencies::{anyhow::Result, wgpu};
use phantom_world::{Filter, WrappingMode};
...
impl Texture {
    ...
    fn map_texture_format(texture_format: phantom_world::Format) -> wgpu::TextureFormat {
